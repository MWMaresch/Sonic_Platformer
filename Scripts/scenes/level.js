...
(function (scenes) {
    class Level extends objects.Scene {
        ...
        createBackground() {
            ...
            this._bgWallImages.push(new createjs.Sprite(spriteAtlas, "ghzbg0"), new createjs.Sprite(spriteAtlas, "ghzbg1"), new createjs.Sprite(spriteAtlas, "ghzbg2"), new createjs.Sprite(spriteAtlas, "ghzbg3"), new createjs.Sprite(spriteAtlas, "ghzbg1"), new createjs.Sprite(spriteAtlas, "ghzbg4"), new createjs.Sprite(spriteAtlas, "ghzbg5"), new createjs.Sprite(spriteAtlas, "ghzbg6"), new createjs.Sprite(spriteAtlas, "ghzbg0"), new createjs.Sprite(spriteAtlas, "ghzbg2"), new createjs.Sprite(spriteAtlas, "ghzbg4"), new createjs.Sprite(spriteAtlas, "ghzbg3"), new createjs.Sprite(spriteAtlas, "ghzbg5"), new createjs.Sprite(spriteAtlas, "ghzbg0"), new createjs.Sprite(spriteAtlas, "ghzbg6"), new createjs.Sprite(spriteAtlas, "ghzbg6"), 
            //then it loops
            new createjs.Sprite(spriteAtlas, "ghzbg0"), new createjs.Sprite(spriteAtlas, "ghzbg1"), new createjs.Sprite(spriteAtlas, "ghzbg2"), new createjs.Sprite(spriteAtlas, "ghzbg3"), new createjs.Sprite(spriteAtlas, "ghzbg1"));
            ...
            this._bgSkyImages.push(new createjs.Sprite(spriteAtlas, "ghzsky0"), new createjs.Sprite(spriteAtlas, "ghzsky1"), new createjs.Sprite(spriteAtlas, "ghzsky3"), new createjs.Sprite(spriteAtlas, "ghzsky4"), new createjs.Sprite(spriteAtlas, "ghzsky5"), new createjs.Sprite(spriteAtlas, "ghzsky6"), new createjs.Sprite(spriteAtlas, "ghzsky0"), new createjs.Sprite(spriteAtlas, "ghzsky2"), new createjs.Sprite(spriteAtlas, "ghzsky4"), new createjs.Sprite(spriteAtlas, "ghzsky1"), new createjs.Sprite(spriteAtlas, "ghzsky5"), new createjs.Sprite(spriteAtlas, "ghzsky1"), new createjs.Sprite(spriteAtlas, "ghzsky6"), new createjs.Sprite(spriteAtlas, "ghzsky6"), new createjs.Sprite(spriteAtlas, "ghzsky0"));
